  ...
  return (
    <section className="mb-8 space-y-3 sm:mb-10">
      {industryTag ? (
        ...
        <h1 className="font-heading max-w-xl text-3xl font-bold tracking-tight sm:text-4xl lg:text-[2.75rem] lg:leading-tight">
          Find your next{" "}
          <span className="text-gradient-brand">Micro-SaaS</span> idea
        </h1>
      )}
